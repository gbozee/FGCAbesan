jQuery(function($) {
    ...
    $('.content').each(function() {
        $tallestCol = 0;
        $(this).find('.members-list li').each(function() {
    ...
    $(".sermon-tabs").hide();
    $(".sermon-media-right .sermon-tabs:first").show();
    $(".sermon-links ul.action-buttons li.link").click(function() {
        $("ul.action-buttons li").removeClass("active");
        $(this).addClass("active");
        $(".sermon-tabs").slideUp();
    ...
    $(".event-tickets").click(function(e) {
        $(".ticket-booking-wrapper").animate({
            ...
            $(".ticket-booking-wrapper").find(".ticket-form").animate({
                opacity: 1
            }, 'medium', 'swing', function() {
                $(".event-ticket-left .ticket-cuts-top").animate({
                    ...
                    $(".event-ticket-left .ticket-cuts-bottom").animate({
                        ...
                        $(".ticket-booking-wrapper").find(".ticket-booking-close").animate({
                            top: '-40px'
                        });
                    });
                });
