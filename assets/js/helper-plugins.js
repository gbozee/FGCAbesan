...
(function(g) {
    ...
    function W(c, b) {
        ...
        function H(a) {
            ...
            j = null ;
            k = 0;
            !n || h === b.fingers || b.fingers === x ? (r = f = Q.pageX,
            s = p = Q.pageY,
            y = (new Date).getTime(),
            b.swipeStatus && (c = l(a, d))) : t(a);
            if (!1 === c)
                return d = m,
                l(a, d),
                c;
        ...
        function J(a) {
            ...
            if (!(d === q || d === m)) {
                ...
                h === b.fingers || b.fingers === x || !n ? (i = U(),
                k = u - y,
                b.swipeStatus && (c = l(a, d, j, i, k)),
                b.triggerOnTouchEnd || (e = !(b.maxTimeThreshold ? !(k >= b.maxTimeThreshold) : 1),
                !0 === D() ? (d = q,
                c = l(a, d)) : e && (d = m,
                l(a, d)))) : (d = m,
                l(a, d));
        ...
        function l(a, c) {
            ...
            if (c == q)
                switch (b.swipe && (d = b.swipe.call(e, a, j, i, k, h)),
                j) {
                case v:
    ...
    var s = function() {
        var s = {
          ...
          , h = function(s) {
            ...
            n.length > 0 && n.is(":hidden") && (o.one("click.superfish", !1),
            "MSPointerDown" === s.type ? o.trigger("focus") : e.proxy(u, o.parent("li"))())
        }
          , u = function() {
            var s = e(this)
              , o = d(s);
          ...
          , f = function(s) {
            ...
            this.superfish("hide"),
            this.parents("." + s.hoverClass).length || (s.onIdle.call(c(this)),
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    ...
                    return i ? (o = n.find(i.popUpSelector).parent("li"),
                    ...
                    i.$path.removeClass(i.hoverClass + " " + s.bcClass).addClass(i.pathClass),
